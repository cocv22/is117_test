...
```mermaid
flowchart LR
    A[Same plain white T-shirt] --> B[Audience situation]
    B --> C[Meaning to emphasize]
    C --> D[Archetype and persuasive principles]
    D --> E[Visual language]
    E --> F[Market presentation]
    F --> G[Audience can compare, choose, or decline]
```
