...
```mermaid
flowchart LR
    A[Product: plain white T-shirt] --> B[Brand meaning: everyday, creative, or adventurous]
    B --> C[Identity: practical person, maker, or explorer]
    C --> D[Audience response: recognizes a possible fit]
    D --> E[Chooses, compares, or declines]
```
